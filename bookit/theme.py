...
.badge.au{background:rgba(157,41,21,.07);color:#7a5a1e}
.stepline{display:flex;gap:9px;align-items:baseline;padding:3px 0;font-size:14px}
.stepline .who{font-family:var(--mono);font-size:9.5px;font-weight:700;letter-spacing:.1em;
  min-width:56px;text-transform:uppercase;opacity:.75}
